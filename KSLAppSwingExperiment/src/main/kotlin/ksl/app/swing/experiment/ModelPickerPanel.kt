 ...
 *  experiment shown in the summary panel — wired through [onModelSelected]. */
internal class ModelPickerPanel(
    ...
    private val combo: JComboBox<String> =
        JComboBox(DefaultComboBoxModel(BundledExperiments.supportedModelIds.toTypedArray())).apply {
