...
import ksl.book.search.BookChunk
...
/**
 * The six book tools. Handlers return markdown; every response ends with citable URLs so students
 * can be pointed at the published book. Copied from the standalone KSLBookServer's ToolHandlers,
 * retargeted onto the KSLBookSearch library; the MCP wiring lives in the aggregated suite.
 */
