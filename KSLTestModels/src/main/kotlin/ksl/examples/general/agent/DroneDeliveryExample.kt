...
class DroneDeliveryExample(parent: ModelElement, name: String? = null) :
    ...
    /**
     * A delivery order in the [DroneDeliveryExample]: the target delivery voxel and the time the order was
     * created. Generated by `OrderGenerator` and dispatched to a drone.
     */
    ...
    /**
     * The order-generating agent in the [DroneDeliveryExample]: an `Agent` whose script creates delivery
     * `Order`s at random inter-arrival times and sends each to the drone dispatcher's mailbox as an agent
     * message.
     */
