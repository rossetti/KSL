 ...
 *
 */
class SeizeTesting(parent: ModelElement, name: String? = null) : ProcessModel(parent, name) {
        ...
        val productionProcess = process(isDefaultProcess = true) {
            ...
            while (!done) {
                ...
                if (isType1){
                    ...
                    delay((90.0 + 50.0)/30.0)  // milling to grinding
                } else {
                    delay((70.0 + 90.0)/30.0) // drilling to planning
                    ...
                    delay(50.0/30.0) // planing to grinding
                }
                ...
                delay(180.0/30.0) // grinding to inspection
                ...
                if (inspectOutcome == 1.0) {
                    ...
                    // passed, send to exit
                    delay(100.0/45.0) // inspection to exit
                    ...
                    delay(250.0/30.0) // inspection to drilling
                } else {
