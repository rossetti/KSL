 ...
 * @author rossetti
 */
class TestNHPPPWLinearRepeat(parent: ModelElement, f: PiecewiseRateFunction, name: String?= null) :
    ...
    private inner class EventListener : GeneratorActionIfc {
        override fun generate(generator: EventGeneratorIfc) {
            ...
            if (t <= 2000.0) {
                ...
                val i: Int = myPWRF.findTimeInterval(t - 2000.0)
