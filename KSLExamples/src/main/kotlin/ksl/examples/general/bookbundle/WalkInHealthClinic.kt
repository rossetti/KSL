...
// Adapted from ksl.examples.book.chapter7.WalkInHealthClinic for the "KSL Book Examples" bundle
...
//    }
    ...
    // Made a control in this bundled copy so the balk threshold is a nominatable
    // decision input (the chapter original leaves it a plain property).
    @set:KSLControl(
