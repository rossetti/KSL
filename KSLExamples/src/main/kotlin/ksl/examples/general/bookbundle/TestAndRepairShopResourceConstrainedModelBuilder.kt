...
/** Named, discoverable [ModelBuilderIfc] for the 'TestAndRepairShopResourceConstrained' book example; the build that [BookExamplesBundle] delegates to. */
class TestAndRepairShopResourceConstrainedModelBuilder : ModelBuilderIfc {
    override fun build(
        ...
        val model = Model("TestAndRepairShopResourceConstrained", autoCSVReports = false)
