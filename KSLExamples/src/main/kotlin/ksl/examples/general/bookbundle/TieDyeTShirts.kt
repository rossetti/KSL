...
// Adapted from ksl.examples.book.chapter6.TieDyeTShirts (Ch6Example9.kt) for the
...
class TieDyeTShirts(
    ...
    private val myOrderSize = RandomVariable(this, mySize, name = "OrderSize")
    private val myOrderType = RandomVariable(this, myType, name = "OrderType")
    private val myShirtMakingTime = RandomVariable(this, UniformRV(15.0, 25.0), name = "ShirtMakingTime")
    private val myPaperWorkTime = RandomVariable(this, UniformRV(8.0, 10.0), name = "PaperworkTime")
    private val myPackagingTime = RandomVariable(this, TriangularRV(5.0, 10.0, 15.0), name = "PackagingTime")
