...
// Adapted from ksl.examples.book.chapter7.StemFairMixerEnhancedSched for the "KSL Book Examples" bundle
...
class StemFairMixerEnhancedSched(parent: ModelElement, name: String? = null) : ProcessModel(parent, name) {
    ...
    // schedule-driven here, so the mixer length and warning time are this
    // variant's nominatable decision inputs.
    @set:KSLControl(
    ...
    private val myNameTagTimeRV = RandomVariable(this, UniformRV((15.0 / 60.0), (45.0 / 60.0), 2), name = "NameTagTime")
    private val myDecideToMix = RandomVariable(this, BernoulliRV(0.4, 3), name = "DecideToMix")
    private val myDecideToLeave = RandomVariable(this, BernoulliRV(0.1, 4), name = "DecideToLeave")
    private val myInteractionTimeRV = RandomVariable(this, TriangularRV(10.0, 15.0, 30.0, 5), name = "InteractionTime")
    private val myDecideRecruiter = RandomVariable(this, BernoulliRV(0.5, 6), name = "DecideRecruiter")
    private val myTalkWithJHBunt = RandomVariable(this, ExponentialRV(6.0, 7), name = "TalkWithJHBuntTime")
    private val myTalkWithMalMart = RandomVariable(this, ExponentialRV(3.0, 8), name = "TalkWithMalMartTime")
    private val myWalkingSpeedRV = TriangularRV(88.0, 176.0, 264.0, 9)

    private val walkToNameTags = RandomVariable(this, 20.0 / myWalkingSpeedRV, name = "WalkToNameTagsTime")
    private val walkFromNameTagsToConversationArea = RandomVariable(this, 30.0 / myWalkingSpeedRV, name = "WalkNameTagsToConversationTime")
    private val walkFromNameTagsToRecruiting = RandomVariable(this, 80.0 / myWalkingSpeedRV, name = "WalkNameTagsToRecruitingTime")
    private val walkFromNameTagsToExit = RandomVariable(this, 140.0 / myWalkingSpeedRV, name = "WalkNameTagsToExitTime")
    private val walkFromConversationAreaToRecruiting = RandomVariable(this, 50.0 / myWalkingSpeedRV, name = "WalkConversationToRecruitingTime")
    private val walkFromConversationAreaToExit = RandomVariable(this, 110.0 / myWalkingSpeedRV, name = "WalkConversationToExitTime")
    private val walkFromRecruitingToExit = RandomVariable(this, 60.0 / myWalkingSpeedRV, name = "WalkRecruitingToExitTime")
