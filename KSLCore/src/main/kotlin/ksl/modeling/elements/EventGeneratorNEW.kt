...
open class EventGeneratorNEW private constructor(
...
) : ModelElement(parent, name), BaseGeneratorIfc by baseEventGenerator,
    BaseGeneratorInitializationCIfc by baseEventGenerator, BaseGeneratorRVIfc {
    ...
    constructor(
        ...
        parent, name, BaseEventGenerator(
            parent, generateAction, timeUntilFirstRV,
            timeBtwEventsRV, maxNumberOfEvents, timeOfTheLastEvent, "${parent.name}:BaseGenerator"
        )
    )
    ...
    constructor(
        ...
        parent, name, BaseEventGenerator(
            parent, generateAction, arrivalsRV,
            arrivalsRV, maxNumberOfEvents, timeOfTheLastEvent, "${parent.name}:BaseGenerator"
        )
    )
