 ...
 * @param timeUntilFirstRV A RVariableIfc object that supplies the time until the first event random variable.
 * @param timeBtwEventsRV A RVariableIfc object that supplies the time between events random variable.
