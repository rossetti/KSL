...
interface BaseGeneratorTimeUntilFirstEventCIfc {
    /**
...
interface BaseGeneratorTimeUntilFirstEventRVCIfc {
    /**
     * Controls the random variable representing the time until the first event that is
     * used at the beginning of each replication to generate the time until the
     * first event. This change becomes effective at the beginning of the next
...
interface BaseGeneratorInitialEventTimeProcessesCIfc {
    /**
...
interface BaseGeneratorInitialTimeBtwEventsCIfc {
    /**
...
interface BaseGeneratorInitialEventTimeProcessesRVCIfc {
    /**
     *  Often the time of the first event and the time between events is
     *  the same distribution. This property causes both [initialTimeUntilFirstEvent]
     *  and [initialTimeBtwEvents] to be set to the same random variable.
...
interface BaseGeneratorInitialTimeBtwEventsRVCIfc  {
    /**
     * Sets the time between events and the maximum number of events to be used
     * to initialize each replication. The time between events cannot evaluate
     * to a constant value of 0.0. The maximum number of events is kept at its
...
interface BaseGeneratorInitializationCIfc {
    /**
 ...
 *  a common use case.
 */
interface BaseGeneratorCIfc : BaseGeneratorTimeUntilFirstEventCIfc, BaseGeneratorInitialTimeBtwEventsCIfc,
    BaseGeneratorInitializationCIfc, BaseGeneratorInitialEventTimeProcessesCIfc
 ...
 *  a common use case.
 */
interface BaseGeneratorRVCIfc : BaseGeneratorTimeUntilFirstEventRVCIfc, BaseGeneratorInitialTimeBtwEventsRVCIfc,
    BaseGeneratorInitializationCIfc

interface BaseGeneratorRVIfc :  BaseGeneratorTimeUntilFirstEventRVCIfc,
    BaseGeneratorInitialTimeBtwEventsRVCIfc, BaseGeneratorTimeBtwEventsRVIfc,
    BaseGeneratorInitialEventTimeProcessesRVCIfc