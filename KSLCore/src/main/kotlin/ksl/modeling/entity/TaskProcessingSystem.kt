...
open class TaskProcessingSystem(
    ...
    inner class ProcessorPerformance(
        parent: ModelElement,
        ...
        override fun replicationEnded() {
            ...
            if (allPerformance) {
                ...
                myFractionFailedTime.value = processor.fractionTimeFailed
                myNumTimesFailed.value = processor.numTimesFailed
