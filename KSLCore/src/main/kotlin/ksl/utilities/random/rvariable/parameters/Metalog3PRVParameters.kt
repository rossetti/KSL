...
/**
 *  Parameters for a three-term metalog random variable.
 *
 ...
 */
class Metalog3PRVParameters : RVParameters(
    rvClassName = RVType.Metalog3P.parametrizedRVClass.simpleName!!,
    rvType = RVType.Metalog3P
    ...
    override fun createRVariable(
        ...
        return Metalog3PRV(
            a1, a2, a3, lowerBound, upperBound, streamNumber, streamProvider
        )
    }

    override fun createDistribution(): Metalog3P {
        val a1 = doubleParameter("a1")
        val a2 = doubleParameter("a2")
        val a3 = doubleParameter("a3")
        val lowerBound = doubleParameter("lowerBound")
        val upperBound = doubleParameter("upperBound")
        return Metalog3P(a1, a2, a3, lowerBound, upperBound)
    }
}
