...
/**
 * A two-term metalog random variable.
 *
 * With both bounds infinite this generates logistic variates; with a finite lower bound, log-logistic ones.
 *
 ...
 */
class Metalog2PRV @JvmOverloads constructor(
    val a1: Double = 0.0,
    val a2: Double = 1.0,
    ...
    private val myCoefficients: DoubleArray = doubleArrayOf(a1, a2)
    ...
    override fun instance(streamNum: Int, rnStreamProvider: RNStreamProviderIfc): Metalog2PRV {
        return Metalog2PRV(
            a1, a2, lowerBound, upperBound, streamNum, rnStreamProvider, name
        )
    }

    override fun toString(): String {
        return "Metalog2PRV(a1=${a1}, a2=${a2}, lowerBound=$lowerBound, upperBound=$upperBound)"
    }

    override val parameters: RVParameters
        get() {
            val parameters: RVParameters = Metalog2PRVParameters()
