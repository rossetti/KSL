...
import ksl.utilities.random.rvariable.Metalog2PRV
 ...
 */
class Metalog2PRVParameters : RVParameters(
    rvClassName = RVType.Metalog2P.parametrizedRVClass.simpleName!!,
    rvType = RVType.Metalog2P
    ...
    override fun createRVariable(
        ...
        return Metalog2PRV(
            a1, a2, lowerBound, upperBound, streamNumber, streamProvider
        )
    }

    override fun createDistribution(): Metalog2P {
        val a1 = doubleParameter("a1")
        val a2 = doubleParameter("a2")
        val lowerBound = doubleParameter("lowerBound")
        val upperBound = doubleParameter("upperBound")
        return Metalog2P(a1, a2, lowerBound, upperBound)
    }
}
