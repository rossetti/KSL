...
/**
 *  Parameters for a five-term metalog random variable.
 *
 ...
 */
class Metalog5PRVParameters : RVParameters(
    rvClassName = RVType.Metalog5P.parametrizedRVClass.simpleName!!,
    rvType = RVType.Metalog5P
    ...
    override fun createRVariable(
        ...
        return Metalog5PRV(
            a1, a2, a3, a4, a5, lowerBound, upperBound, streamNumber, streamProvider
        )
    }

    override fun createDistribution(): Metalog5P {
        val a1 = doubleParameter("a1")
        val a2 = doubleParameter("a2")
        val a3 = doubleParameter("a3")
        val a4 = doubleParameter("a4")
        ...
        val lowerBound = doubleParameter("lowerBound")
        val upperBound = doubleParameter("upperBound")
        return Metalog5P(a1, a2, a3, a4, a5, lowerBound, upperBound)
    }
}
