...
import ksl.utilities.io.dbutil.SQLiteDb.Companion
...
/**
 *  Facilitates the creation of a database backed by Derby. The database
 *  will be empty.
 *
 * @param dbName the name of the database
 * @param dbDirectory the directory containing the database. By default, KSL.dbDir.
 * @param create If true, an existing database in the supplied directory with
