...
ALTER TABLE KSL_DB.MODEL_ELEMENT
	ADD CONSTRAINT ME_SIMRUN_FK FOREIGN KEY (SIM_RUN_ID_FK) REFERENCES KSL_DB.SIMULATION_RUN (ID) ON DELETE CASCADE;
	
CREATE INDEX ME_SIMRUN_FK_INDEX ON KSL_DB.MODEL_ELEMENT(SIM_RUN_ID_FK);
...
ALTER TABLE KSL_DB.CONTROL
    ADD CONSTRAINT CONTROL_SIMRUN_FK FOREIGN KEY (SIM_RUN_ID_FK) REFERENCES KSL_DB.SIMULATION_RUN (ID) ON DELETE CASCADE;

ALTER TABLE KSL_DB.CONTROL
    ADD CONSTRAINT CTL_MODEL_ELEMENT_FK FOREIGN KEY (SIM_RUN_ID_FK, ELEMENT_ID_FK)
        REFERENCES KSL_DB.MODEL_ELEMENT (SIM_RUN_ID_FK, ELEMENT_ID) ON DELETE CASCADE;
...
ALTER TABLE KSL_DB.RV_PARAMETER
    ADD CONSTRAINT RV_PARAM_SIMRUN_FK FOREIGN KEY (SIM_RUN_ID_FK) REFERENCES KSL_DB.SIMULATION_RUN (ID) ON DELETE CASCADE;

ALTER TABLE KSL_DB.RV_PARAMETER
    ADD CONSTRAINT RV_PARAM_MODEL_ELEMENT_FK FOREIGN KEY (SIM_RUN_ID_FK, ELEMENT_ID_FK)
        REFERENCES KSL_DB.MODEL_ELEMENT (SIM_RUN_ID_FK, ELEMENT_ID) ON DELETE CASCADE;
...
ALTER TABLE KSL_DB.WITHIN_REP_STAT 
	ADD CONSTRAINT WRS_SIMRUN_FK FOREIGN KEY (SIM_RUN_ID_FK) REFERENCES KSL_DB.SIMULATION_RUN (ID) ON DELETE CASCADE;
...
ALTER TABLE KSL_DB.ACROSS_REP_STAT 
	ADD CONSTRAINT ARS_SIMRUN_FK FOREIGN KEY (SIM_RUN_ID_FK) REFERENCES KSL_DB.SIMULATION_RUN (ID) ON DELETE CASCADE;
...
ALTER TABLE KSL_DB.WITHIN_REP_COUNTER_STAT 
	ADD CONSTRAINT WRCS_SIMRUN_FK FOREIGN KEY (SIM_RUN_ID_FK) REFERENCES KSL_DB.SIMULATION_RUN (ID) ON DELETE CASCADE;
...
ALTER TABLE KSL_DB.BATCH_STAT
	ADD CONSTRAINT BS_SIMRUN_FK FOREIGN KEY (SIM_RUN_ID_FK) REFERENCES KSL_DB.SIMULATION_RUN (ID) ON DELETE CASCADE;
...
CREATE VIEW KSL_DB.WITHIN_REP_RESPONSE_VIEW (SIM_RUN_ID_FK, EXP_NAME, STAT_NAME, REP_NUM, AVERAGE)
AS (SELECT KSL_DB.WITHIN_REP_STAT.SIM_RUN_ID_FK, EXP_NAME, STAT_NAME, REP_NUM, AVERAGE
  FROM KSL_DB.SIMULATION_RUN, KSL_DB.MODEL_ELEMENT,KSL_DB.WITHIN_REP_STAT
  WHERE KSL_DB.SIMULATION_RUN.ID = KSL_DB.WITHIN_REP_STAT.SIM_RUN_ID_FK
    AND KSL_DB.SIMULATION_RUN.ID = KSL_DB.MODEL_ELEMENT.SIM_RUN_ID_FK
    ...
    ORDER BY KSL_DB.WITHIN_REP_STAT.SIM_RUN_ID_FK, EXP_NAME, STAT_NAME, REP_NUM);
...
CREATE VIEW KSL_DB.WITHIN_REP_COUNTER_VIEW (SIM_RUN_ID_FK, EXP_NAME, STAT_NAME, REP_NUM, LAST_VALUE)
  AS (SELECT KSL_DB.WITHIN_REP_COUNTER_STAT.SIM_RUN_ID_FK, EXP_NAME, STAT_NAME, REP_NUM, LAST_VALUE
  FROM KSL_DB.SIMULATION_RUN, KSL_DB.WITHIN_REP_COUNTER_STAT, KSL_DB.MODEL_ELEMENT
  WHERE KSL_DB.SIMULATION_RUN.ID = KSL_DB.WITHIN_REP_COUNTER_STAT.SIM_RUN_ID_FK
    AND KSL_DB.SIMULATION_RUN.ID = KSL_DB.MODEL_ELEMENT.SIM_RUN_ID_FK
    ...
    ORDER BY KSL_DB.WITHIN_REP_COUNTER_STAT.SIM_RUN_ID_FK, EXP_NAME, STAT_NAME, REP_NUM);  
  
-- ACROSS_REP_VIEW represents a reduced view of the across replication responses containing only n, avg, and stddev       
CREATE VIEW KSL_DB.ACROSS_REP_VIEW (SIM_RUN_ID_FK, EXP_NAME, STAT_NAME, STAT_COUNT, AVERAGE, STD_DEV)
AS (SELECT KSL_DB.ACROSS_REP_STAT.SIM_RUN_ID_FK, EXP_NAME, STAT_NAME, STAT_COUNT, AVERAGE, STD_DEV
  FROM KSL_DB.SIMULATION_RUN, KSL_DB.ACROSS_REP_STAT, KSL_DB.MODEL_ELEMENT
  WHERE KSL_DB.SIMULATION_RUN.ID = KSL_DB.ACROSS_REP_STAT.SIM_RUN_ID_FK
    AND KSL_DB.SIMULATION_RUN.ID = KSL_DB.MODEL_ELEMENT.SIM_RUN_ID_FK
    ...
    ORDER BY STAT_NAME,KSL_DB.ACROSS_REP_STAT.SIM_RUN_ID_FK, EXP_NAME);  

-- BATCH_STAT_VIEW represents a reduced view of the batch statistics responses containing only n, avg, and stddev  
CREATE VIEW KSL_DB.BATCH_STAT_VIEW (SIM_RUN_ID_FK, EXP_NAME, STAT_NAME, STAT_COUNT, AVERAGE, STD_DEV)
  AS (SELECT KSL_DB.BATCH_STAT.SIM_RUN_ID_FK, EXP_NAME, STAT_NAME, STAT_COUNT, AVERAGE, STD_DEV
  FROM KSL_DB.SIMULATION_RUN, KSL_DB.BATCH_STAT, KSL_DB.MODEL_ELEMENT
  WHERE KSL_DB.SIMULATION_RUN.ID = KSL_DB.BATCH_STAT.SIM_RUN_ID_FK
    AND KSL_DB.SIMULATION_RUN.ID = KSL_DB.MODEL_ELEMENT.SIM_RUN_ID_FK
    ...
    ORDER BY STAT_NAME,KSL_DB.BATCH_STAT.SIM_RUN_ID_FK, EXP_NAME); 
...
CREATE VIEW KSL_DB.WITHIN_REP_VIEW (SIM_RUN_ID_FK, EXP_NAME, STAT_NAME, REP_NUM, VALUE) AS
...
as (select KSL_DB.SIMULATION_RUN.SIM_NAME, A.SIM_RUN_ID_FK AS A_SIM_NUM, A.STAT_NAME, A.EXP_NAME as A_EXP_NAME, A.REP_NUM, A.VALUE as A_VALUE,
    ...
    from KSL_DB.WITHIN_REP_VIEW as A, KSL_DB.WITHIN_REP_VIEW as B, KSL_DB.SIMULATION_RUN
    where A.SIM_RUN_ID_FK = KSL_DB.SIMULATION_RUN.ID
