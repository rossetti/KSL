...
ALTER TABLE KSL_DB.WITHIN_REP_STAT
    ADD CONSTRAINT WRS_MODEL_ELEMENT_FK FOREIGN KEY (ELEMENT_ID_FK)
        REFERENCES KSL_DB.MODEL_ELEMENT (ELEMENT_ID) ON DELETE CASCADE;
...
ALTER TABLE KSL_DB.ACROSS_REP_STAT
    ADD CONSTRAINT ARS_MODEL_ELEMENT_FK FOREIGN KEY (ELEMENT_ID_FK)
        REFERENCES KSL_DB.MODEL_ELEMENT (ELEMENT_ID) ON DELETE CASCADE;
...
ALTER TABLE KSL_DB.WITHIN_REP_COUNTER_STAT
    ADD CONSTRAINT WRCS_MODEL_ELEMENT_FK FOREIGN KEY (ELEMENT_ID_FK)
        REFERENCES KSL_DB.MODEL_ELEMENT (ELEMENT_ID) ON DELETE CASCADE;
...
ALTER TABLE KSL_DB.BATCH_STAT
    ADD CONSTRAINT BS_MODEL_ELEMENT_FK FOREIGN KEY (ELEMENT_ID_FK)
        REFERENCES KSL_DB.MODEL_ELEMENT (ELEMENT_ID) ON DELETE CASCADE;
