...
ALTER TABLE KSL_DB.TIME_SERIES_RESPONSE
    ADD CONSTRAINT TSR_UNIQUE_ELEMENT_SIMRUN_REPNUM_PERIOD UNIQUE (ELEMENT_ID_FK, SIM_RUN_ID_FK, REP_ID, PERIOD);
...
CREATE VIEW KSL_DB.TIME_SERIES_RESPONSE_ACROSS_REP_VIEW as
...
from KSL_DB.TIME_SERIES_RESPONSE, KSL_DB.EXPERIMENT, KSL_DB.SIMULATION_RUN, KSL_DB.MODEL_ELEMENT
WHERE KSL_DB.EXPERIMENT.EXP_ID = KSL_DB.SIMULATION_RUN.EXP_ID_FK
  AND KSL_DB.SIMULATION_RUN.RUN_ID = KSL_DB.TIME_SERIES_RESPONSE.SIM_RUN_ID_FK
  AND KSL_DB.EXPERIMENT.EXP_ID = KSL_DB.MODEL_ELEMENT.EXP_ID_FK
  AND KSL_DB.MODEL_ELEMENT.ELEMENT_ID = KSL_DB.TIME_SERIES_RESPONSE.ELEMENT_ID_FK
  AND KSL_DB.MODEL_ELEMENT.ELEMENT_NAME = KSL_DB.TIME_SERIES_RESPONSE.STAT_NAME
