...
ORDER BY EXP_NAME, RUN_NAME, KSL_DB.EXPERIMENT.NUM_REPS, START_REP_ID, LAST_REP_ID, STAT_NAME, REP_ID;
...
FROM KSL_DB.EXPERIMENT,
     ...
     KSL_DB.MODEL_ELEMENT
WHERE KSL_DB.EXPERIMENT.IS_CHUNKED = FALSE
  AND KSL_DB.EXPERIMENT.NUM_REPS = KSL_DB.SIMULATION_RUN.NUM_REPS
