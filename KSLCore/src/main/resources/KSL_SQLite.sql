...
(
    ...
    RUN_START_TIME_STAMP INTEGER,
    RUN_END_TIME_STAMP   INTEGER,
...
(
    ...
    FOREIGN KEY (SIM_RUN_ID_FK) REFERENCES SIMULATION_RUN (RUN_ID) ON DELETE CASCADE,
    UNIQUE (ELEMENT_ID_FK, SIM_RUN_ID_FK, REP_ID, PERIOD)
);
...
CREATE VIEW EXP_STAT_REP_VIEW(EXP_NAME, STAT_NAME, REP_ID, REP_VALUE) AS
...
CREATE VIEW ACROSS_REP_VIEW (EXP_NAME, STAT_NAME, STAT_COUNT, AVERAGE, STD_DEV)
AS
...
CREATE VIEW BATCH_STAT_VIEW (EXP_NAME, RUN_NAME, REP_ID, STAT_NAME, STAT_COUNT, AVERAGE, STD_DEV)
AS
SELECT EXP_NAME,
       RUN_NAME,
       REP_ID,
...
WHERE EXPERIMENT.EXP_ID = SIMULATION_RUN.EXP_ID_FK
  AND SIMULATION_RUN.RUN_ID = TIME_SERIES_RESPONSE.SIM_RUN_ID_FK
  AND EXPERIMENT.EXP_ID = MODEL_ELEMENT.EXP_ID_FK
  AND MODEL_ELEMENT.ELEMENT_ID = TIME_SERIES_RESPONSE.ELEMENT_ID_FK
  AND MODEL_ELEMENT.ELEMENT_NAME = TIME_SERIES_RESPONSE.STAT_NAME
group by EXP_NAME, ELEMENT_ID_FK, SIM_RUN_ID_FK, STAT_NAME, PERIOD, START_TIME, END_TIME
order by EXP_NAME, ELEMENT_ID_FK, SIM_RUN_ID_FK, STAT_NAME, PERIOD, START_TIME, END_TIME;