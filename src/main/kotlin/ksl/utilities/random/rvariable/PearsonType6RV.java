...
public final class PearsonType6RV extends AbstractRVariable {
    ...
    public static RVControls makeControls() {
        return new RVControls(ksl.utilities.random.rvariable.RVariableIfc.RVType.PearsonType6) {
            @Override
            protected final void fillControls() {
                addDoubleControl("alpha1", 2.0);
                addDoubleControl("alpha2", 3.0);
                addDoubleControl("beta", 1.0);
                setName(ksl.utilities.random.rvariable.RVariableIfc.RVType.PearsonType6.name());
            }
