...
public final class GeometricRV extends AbstractRVariable {
    ...
    public static RVControls makeControls() {
        return new RVControls(ksl.utilities.random.rvariable.RVariableIfc.RVType.Geometric) {
            @Override
            protected final void fillControls() {
                addDoubleControl("ProbOfSuccess", 0.5);
                setName(ksl.utilities.random.rvariable.RVariableIfc.RVType.Geometric.name());
            }
