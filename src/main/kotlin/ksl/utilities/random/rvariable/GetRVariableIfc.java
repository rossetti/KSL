...
public interface GetRVariableIfc {
     ...
     */
    ksl.utilities.random.rvariable.RVariableIfc getRandomVariable(RNStreamIfc rng);

    /**
     * @param streamNum the stream number to use
     * @return a random variable
     */
    default ksl.utilities.random.rvariable.RVariableIfc getRandomVariable(int streamNum) {
