...
public final class LogLogisticRV extends AbstractRVariable {
    ...
    public static RVControls makeControls() {
        return new RVControls(ksl.utilities.random.rvariable.RVariableIfc.RVType.LogLogistic) {
            @Override
            protected final void fillControls() {
                addDoubleControl("shape", 1.0);
                addDoubleControl("scale", 1.0);
                setName(ksl.utilities.random.rvariable.RVariableIfc.RVType.LogLogistic.name());
            }
