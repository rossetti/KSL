...
public final class EmpiricalRV extends AbstractRVariable {
    ...
    @Override
    public ksl.utilities.random.rvariable.RVariableIfc newInstance(RNStreamIfc rng) {
    ...
    public static RVControls makeControls() {
        return new RVControls(ksl.utilities.random.rvariable.RVariableIfc.RVType.Empirical) {
            @Override
            protected final void fillControls() {
                addDoubleArrayControl("Population", new double[1]);
                setName(ksl.utilities.random.rvariable.RVariableIfc.RVType.Empirical.name());
            }
