...
public final class NegativeBinomialRV extends AbstractRVariable {
    ...
    public static RVControls makeControls() {
        return new RVControls(ksl.utilities.random.rvariable.RVariableIfc.RVType.NegativeBinomial) {
            @Override
            protected final void fillControls() {
                addDoubleControl("ProbOfSuccess", 0.5);
                addIntegerControl("NumSuccesses", 1);
                setName(ksl.utilities.random.rvariable.RVariableIfc.RVType.NegativeBinomial.name());
            }
