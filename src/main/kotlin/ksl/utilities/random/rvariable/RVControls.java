...
public abstract class RVControls extends Controls {
    ...
    private final ksl.utilities.random.rvariable.RVariableIfc.RVType myType;

    public RVControls(ksl.utilities.random.rvariable.RVariableIfc.RVType type) {
     ...
     */
    public final ksl.utilities.random.rvariable.RVariableIfc.RVType getType() {
        return myType;
    }
     ...
     * with a new stream
     */
    public final ksl.utilities.random.rvariable.RVariableIfc makeRVariable() {
     ...
     * stream number
     */
    public final ksl.utilities.random.rvariable.RVariableIfc makeRVariable(int streamNumber) {
