...
public final class DUniformRV extends AbstractRVariable {
    ...
    public static RVControls makeControls() {
        return new RVControls(ksl.utilities.random.rvariable.RVariableIfc.RVType.DUniform) {
            @Override
            protected final void fillControls() {
                addIntegerControl("min", 0);
                addIntegerControl("max", 1);
                setName(ksl.utilities.random.rvariable.RVariableIfc.RVType.DUniform.name());
            }
