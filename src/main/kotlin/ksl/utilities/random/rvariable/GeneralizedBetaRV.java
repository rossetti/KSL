...
public final class GeneralizedBetaRV extends AbstractRVariable {
    ...
    private final ksl.utilities.random.rvariable.BetaRV myBeta;
    ...
    public static RVControls makeControls() {
        return new RVControls(ksl.utilities.random.rvariable.RVariableIfc.RVType.GeneralizedBeta) {
            @Override
            protected final void fillControls() {
                ...
                setName(ksl.utilities.random.rvariable.RVariableIfc.RVType.GeneralizedBeta.name());
            }
