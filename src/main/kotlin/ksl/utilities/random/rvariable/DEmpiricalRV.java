...
public final class DEmpiricalRV extends AbstractRVariable {
    ...
    public static RVControls makeControls() {
        return new RVControls(ksl.utilities.random.rvariable.RVariableIfc.RVType.DEmpirical) {
            @Override
            protected final void fillControls() {
                addDoubleArrayControl("values", new double[]{0.0, 1.0});
                addDoubleArrayControl("cdf", new double[]{0.5, 1.0});
                setName(ksl.utilities.random.rvariable.RVariableIfc.RVType.DEmpirical.name());
            }
