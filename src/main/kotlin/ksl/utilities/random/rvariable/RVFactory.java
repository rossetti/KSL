...
import static ksl.utilities.random.rvariable.RVariableIfc.RVType.*;
...
public class RVFactory {
    ...
    private static Map<ksl.utilities.random.rvariable.RVariableIfc.RVType, RVControls> myFactories;
