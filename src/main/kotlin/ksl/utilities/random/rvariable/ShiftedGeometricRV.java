...
public final class ShiftedGeometricRV extends AbstractRVariable {
    ...
    public static RVControls makeControls() {
        return new RVControls(ksl.utilities.random.rvariable.RVariableIfc.RVType.ShiftedGeometric) {
            @Override
            protected final void fillControls() {
                addDoubleControl("ProbOfSuccess", 0.5);
                setName(ksl.utilities.random.rvariable.RVariableIfc.RVType.ShiftedGeometric.name());
            }
