...
public final class WeibullRV extends AbstractRVariable {
    ...
    public static RVControls makeControls() {
        return new RVControls(ksl.utilities.random.rvariable.RVariableIfc.RVType.Weibull) {
            @Override
            protected final void fillControls() {
                addDoubleControl("shape", 1.0);
                addDoubleControl("scale", 1.0);
                setName(ksl.utilities.random.rvariable.RVariableIfc.RVType.Weibull.name());
            }
