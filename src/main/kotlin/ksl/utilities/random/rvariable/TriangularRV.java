...
public final class TriangularRV extends AbstractRVariable {
    ...
    public static RVControls makeControls() {
        return new RVControls(ksl.utilities.random.rvariable.RVariableIfc.RVType.Triangular) {
            @Override
            protected final void fillControls() {
                addDoubleControl("min", 0.0);
                addDoubleControl("mode", 0.5);
                addDoubleControl("max", 1.0);
                setName(ksl.utilities.random.rvariable.RVariableIfc.RVType.Triangular.name());
            }
