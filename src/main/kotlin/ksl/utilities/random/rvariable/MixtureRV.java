...
public final class MixtureRV extends AbstractRVariable {
    ...
    private final DEmpiricalList<ksl.utilities.random.rvariable.RVariableIfc> myRVList;
     ...
     */
    public MixtureRV(List<ksl.utilities.random.rvariable.RVariableIfc> list, double[] cdf) {
     ...
     */
    public MixtureRV(List<ksl.utilities.random.rvariable.RVariableIfc> list, double[] cdf, int streamNum) {
     ...
     */
    public MixtureRV(List<ksl.utilities.random.rvariable.RVariableIfc> list, double[] cdf, RNStreamIfc stream) {
        super(stream);
