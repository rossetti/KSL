...
public final class LaplaceRV extends AbstractRVariable {
    ...
    public static RVControls makeControls() {
        return new RVControls(ksl.utilities.random.rvariable.RVariableIfc.RVType.Laplace) {
            @Override
            protected final void fillControls() {
                addDoubleControl("mean", 0.0);
                addDoubleControl("scale", 1.0);
                setName(ksl.utilities.random.rvariable.RVariableIfc.RVType.Laplace.name());
            }
