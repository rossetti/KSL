...
public final class LognormalRV extends AbstractRVariable {
    ...
    public static RVControls makeControls() {
        return new RVControls(ksl.utilities.random.rvariable.RVariableIfc.RVType.Lognormal) {
            @Override
            protected final void fillControls() {
                addDoubleControl("mean", 1.0);
                addDoubleControl("variance", 1.0);
                setName(ksl.utilities.random.rvariable.RVariableIfc.RVType.Lognormal.name());
            }
