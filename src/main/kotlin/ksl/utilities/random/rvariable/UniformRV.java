...
public final class UniformRV extends AbstractRVariable {
    ...
    public static RVControls makeControls() {
        return new RVControls(ksl.utilities.random.rvariable.RVariableIfc.RVType.Uniform) {
            @Override
            protected final void fillControls() {
                addDoubleControl("min", 0.0);
                addDoubleControl("max", 1.0);
                setName(ksl.utilities.random.rvariable.RVariableIfc.RVType.Uniform.name());
            }
