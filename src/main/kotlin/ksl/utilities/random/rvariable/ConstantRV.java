 ...
 */
public class ConstantRV implements ksl.utilities.random.rvariable.RVariableIfc, IdentityIfc {
    ...
    @Override
    public final ksl.utilities.random.rvariable.RVariableIfc newAntitheticInstance() {
        return new ConstantRV(myValue);
    }
    ...
    public static RVControls makeControls() {
        return new RVControls(ksl.utilities.random.rvariable.RVariableIfc.RVType.Constant) {
            @Override
            protected final void fillControls() {
                addDoubleControl("value", 1.0);
                setName(ksl.utilities.random.rvariable.RVariableIfc.RVType.Constant.name());
            }
