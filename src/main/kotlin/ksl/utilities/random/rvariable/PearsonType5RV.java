...
public final class PearsonType5RV extends AbstractRVariable {
    ...
    public static RVControls makeControls() {
        return new RVControls(ksl.utilities.random.rvariable.RVariableIfc.RVType.PearsonType5) {
            @Override
            protected final void fillControls() {
                addDoubleControl("shape", 1.0);
                addDoubleControl("scale", 1.0);
                setName(ksl.utilities.random.rvariable.RVariableIfc.RVType.PearsonType5.name());
            }
