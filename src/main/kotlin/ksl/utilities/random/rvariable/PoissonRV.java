...
public final class PoissonRV extends AbstractRVariable {
    ...
    public static RVControls makeControls() {
        return new RVControls(ksl.utilities.random.rvariable.RVariableIfc.RVType.Poisson) {
            @Override
            protected final void fillControls() {
                addDoubleControl("mean", 1.0);
                setName(ksl.utilities.random.rvariable.RVariableIfc.RVType.Poisson.name());
            }
