...
public final class ShiftedRV extends AbstractRVariable {
    ...
    private final ksl.utilities.random.rvariable.RVariableIfc myRV;
     ...
     */
    public ShiftedRV(double shift, ksl.utilities.random.rvariable.RVariableIfc rv) {
     ...
     */
    public ShiftedRV(double shift, ksl.utilities.random.rvariable.RVariableIfc rv, int streamNum) {
     ...
     */
    public ShiftedRV(double shift, ksl.utilities.random.rvariable.RVariableIfc rv, RNStreamIfc rng) {
        super(rng);
