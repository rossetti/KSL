...
public final class ChiSquaredRV extends AbstractRVariable {
    ...
    public static RVControls makeControls() {
        return new RVControls(ksl.utilities.random.rvariable.RVariableIfc.RVType.ChiSquared) {
            @Override
            protected final void fillControls() {
                addDoubleControl("dof", 1.0);
                setName(ksl.utilities.random.rvariable.RVariableIfc.RVType.ChiSquared.name());
            }
