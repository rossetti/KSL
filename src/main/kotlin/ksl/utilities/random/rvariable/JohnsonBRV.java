...
public final class JohnsonBRV extends AbstractRVariable {
    ...
    public static RVControls makeControls() {
        return new RVControls(ksl.utilities.random.rvariable.RVariableIfc.RVType.JohnsonB) {
            @Override
            protected final void fillControls() {
                ...
                setName(ksl.utilities.random.rvariable.RVariableIfc.RVType.JohnsonB.name());
            }
