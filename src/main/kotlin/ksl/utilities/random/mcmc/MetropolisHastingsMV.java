...
import ksl.utilities.random.mcmc.ProposalFunctionMVIfc;
...
public class MetropolisHastingsMV implements RNStreamControlIfc, SetRandomNumberStreamIfc, GetRandomNumberStreamIfc, ObservableIfc {
    ...
    protected final ksl.utilities.random.mcmc.ProposalFunctionMVIfc myProposalFun;
     ...
     */
    public MetropolisHastingsMV(double[] initialX, FunctionMVIfc targetFun, ksl.utilities.random.mcmc.ProposalFunctionMVIfc proposalFun) {
        if (initialX == null){
