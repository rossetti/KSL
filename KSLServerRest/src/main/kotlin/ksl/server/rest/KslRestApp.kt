...
/** One author-curated recipe (name + `ConfigRecipeKind`). */
@Serializable
data class RecipeInfo(val name: String, val kind: String)
...
fun Application.kslRestModule(
    ...
    routing {
        ...
        get("/bundles/{bundleId}/models/{modelId}/recipes") {
            call.respond(service.recipeList(call.parameters["bundleId"]!!, call.parameters["modelId"]!!))
        }
