...
/**
 * The eight code tools. Handlers return markdown; responses cite the GitHub
 * source URL so students can be pointed at the actual KSL code they are asking
 * about. Nothing here calls the network — everything is served from the bundled
 * index.
 */
class ToolHandlers(
