...
class BundleDirectoryWatcher(
    ...
    /** Single-directory convenience (the common case and existing callers). */
    constructor(registry: BundleRegistry, dir: Path, interval: Duration = 5.seconds) :
        this(registry, listOf(dir), interval)
    ...
    companion object {
         ...
         */
        fun defaultDirs(): List<Path> = ServerConfig().bundleDirs()
    }
}
