...
data class AnimationLayout(
    ...
    companion object {
        ...
        // SPIKE: readFromFile/read/tomlFormat/fromToml/readTomlFromFile lifted out ->
        // AnimationLayoutFiles.kt (JVM-only, same package). This is Phase 1's single KSLCore edit.
    }
}
