...
// SPIKE: toGridGraph() removed - it reaches into GridGraph (499 lines). In Phase 1 it becomes a
// KSLCore-side same-package extension, exactly like AnimationLayoutFiles.kt.
