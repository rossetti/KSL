...
/**
 * A minimal no-terminal setup window (Phase 9 student jar, T5). Double-clicking the
 * jar opens this; the buttons delegate to the same tested logic the console modes
 * use ([AgentSetup], [buildSetupReport] / [buildDoctorReport] / [buildRemoveReport]),
 * so GUI and console never diverge.
 */
        ...
        SwingUtilities.invokeLater {
            val output = JTextArea(18, 64).apply {
                ...
                text = "Click \"Configure my coding agent\" to wire up Claude Desktop / Codex,\n" +
                    "then restart your agent and ask it to list the KSL models.\n\n" +
            ...
            val remove = JButton("Remove KSL").apply {
            ...
            val header = JLabel("KSL MCP Server - Setup").apply {
