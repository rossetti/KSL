...
/**
 * A minimal no-terminal setup window, ported from the KSL Book MCP server.
 * Double-clicking the jar opens this; the buttons delegate to the same tested
 * logic the console modes use ([AgentSetup], [buildSetupReport] /
 * [buildDoctorReport] / [buildRemoveReport]), so GUI and console never diverge.
 */
        ...
        SwingUtilities.invokeLater {
            val output = JTextArea(18, 64).apply {
                ...
                text = "Click \"Configure my coding agent\" to wire up Claude Desktop / Codex,\n" +
                    "then restart your agent and ask it about the KSL source code.\n\n" +
            ...
            val remove = JButton("Remove KSL Code").apply {
            ...
            val header = JLabel("KSL Code MCP Server - Setup").apply {
            ...
            JFrame("KSL Code MCP Server - Setup").apply {
